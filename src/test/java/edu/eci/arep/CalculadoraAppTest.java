...
import edu.eci.arep.exceptions.ListaException;
...
public class CalculadoraAppTest{
    ...
    public void CalcularMediaYDesviacion1() throws IOException {
        String resp = CalculadoraApp.calcularMediaYDesviacion("src/test/java/edu/eci/arep/Prueba2.txt");
    ...
    public void CalcularMediaYDesviacion2() throws IOException {
        String resp = CalculadoraApp.calcularMediaYDesviacion("src/test/java/edu/eci/arep/Prueba1.txt");
